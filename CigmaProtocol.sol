...
contract CigmaProtocol is ERC20Detailed, Ownable {
    using SafeMath for uint256;
    using SafeMathInt for int256;

    string public _name = "Cigma Protocol";
    string public _symbol = "CIGMA";
    ...
    uint256 public cigmaBankFee = 20;
    uint256 public nftHolderFee = 20;

    uint256 public sellFee = cigmaBankFee.add(nftHolderFee);
    ...
    address public cigmaBankReceiver;
    ...
    uint256 private constant MAX_SUPPLY = 5000 * 10**6 * 10**DECIMALS;
    ...
    constructor() ERC20Detailed(_name, _symbol, uint8(DECIMALS)) Ownable() {
        ...
        lpReceiver = 0x2dadb8361D93A048cE7358ddB9e4748919d543CA;
        treasuryReceiver = 0xc7bC20b65f346144e8c06B08D05E714db70523C2;
        insuranceReceiver = 0xc4A7B646b5dD8932f0AB308C3135BA0B8956bCCF;
        cigmaBankReceiver = 0x86081DF50687b3e11c79cD3fbD2B65ae9cF1160D;
        nftHolderReceiver = 0x32177da2eDDd748D720C43100167587260CaBF0C;
    ...
    function setNormalFees() external onlyOwner {
        ...
        sellFee = cigmaBankFee.add(nftHolderFee);
    ...
    function rebase() internal {
        ...
        uint256 rebaseRate = 9444 * 10**18;
        uint256 minuteRebaseRate = 17100 * 10**18;
        uint256 hourRebaseRate = 1000000 * 10**18;
        uint256 dayRebaseRate = 188800000 * 10**18;
    ...
    function swapBack() internal swapping {
        ...
        (success, ) = payable(insuranceReceiver).call{
            value: currentBalance.mul(insuranceFee).div(_currentFee),
            gas: 30000
        }("");

        (success, ) = payable(cigmaBankReceiver).call{
            value: currentBalance.mul(cigmaBankFee).div(_currentFee),
            gas: 30000
        }("");

        (success, ) = payable(nftHolderReceiver).call{
            value: currentBalance.mul(nftHolderFee).div(_currentFee),
            gas: 30000
        }("");
    }
    ...
    function airdrop(
        ...
        require(this.balanceOf(from) >= token, "Not enough tokens");
